 ...
 * @since 1.1
 */
public class SpiritTest extends AbstractTestItem {
    private Spirit spirit;
    private Spirit wrongSpirit;
    private Sorcerer sorcerer;

    @Override
    public void setTestItem() {
        expectedName = "Common spirit";
        expectedPower = 10;
        expectedMinRange = 1;
        expectedMaxRange = 2;
        spirit = new Spirit(expectedName, expectedPower, expectedMinRange, expectedMaxRange);
    }
    ...
    public void setWrongRangeItem() {
        wrongSpirit = new Spirit("Wrong spirit", 0, -1, -2);
    }
